...
* `requirements.txt` – lists the Python packages required to run the analysis. Run in your terminal: 
...
The selected predictor variables are: 
    <p style='margin-left: 30px;'>`superhost_status`: indicates whether the host has Airbnb Superhost status. <br>
    ...
    `rating`: the overall rating received by the listing. </p>